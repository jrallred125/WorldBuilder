...
namespace WorldBuilderWPF.MVVM.ViewModel
{
    public class CharacterDetailsViewModel : ObservableObject
    {
        ...
        public RelayCommand ExportCharacterCommand { get; set; }
        ...
        public CharacterDetailsViewModel(CharacterModel character, CharactersViewModel charactersViewModel)
        {
            ...
            ExportCharacterCommand = new RelayCommand(o => 
            {
                ObservableCollectionEx<CharacterModel> characters = new ObservableCollectionEx<CharacterModel>();
                string filepath = new FileDialogService().SaveFileDialogJson();
                characters.Add(character);
                DataController.Instance.ExportCharacters(characters, filepath);            
            });
        }
