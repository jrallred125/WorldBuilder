...
namespace WorldBuilderWPF.MVVM.ViewModel
{
    public class ItemDetailsViewModel :ObservableObject
    {
        ...
        public RelayCommand ExportItemCommand { get; set; }
        ...
        public ItemDetailsViewModel(ItemModel item, ItemsViewModel itemsVm)
        {
            ...
            ExportItemCommand = new RelayCommand(o =>
            {
                ObservableCollectionEx<IItemModel> items = new ObservableCollectionEx<IItemModel>();
                string filepath = new FileDialogService().SaveFileDialogJson();
                items.Add(item);
                DataController.Instance.ExportItems(items, filepath);
            });
